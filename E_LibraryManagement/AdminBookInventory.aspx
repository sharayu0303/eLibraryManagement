<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminBookInventory.aspx.cs" Inherits="E_LibraryManagement.AdminBookInventory" %>
                ...
                <div class="card" style="border-color: forestgreen">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img id="imgview" width="80" src="book_inventory/books.png" />
                                </center>
                            </div>
                        </div>
                        ...
                        <%--Language, Author Name, Genre, Publisher Name, Publish Date--%>
                        <div class="row mt-3">
                            <div class="col-md-4 ">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <asp:Button type="button" class="btn btn-warning btn-lg btn-block  col-12 mx-auto" ID="Button2" runat="server" Text="Update" OnClick="Button2_Click" />
                                </div>
                            </div>
